...
class Mlecz(Plant):
    def __init__(self, position, Settings):
        ...
        self.symbol = self.Settings.symbol_mlecza
        self.power = 0
        self.color = self.Settings.color_mlecza
    ...
    def action(self, objects):
        ...
        if objects[next_point.x][next_point.y] is not None or random.randint(0, 20) > 2 or self.Settings.max_count_trawy < 0:
